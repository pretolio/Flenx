...
.fxcmp__t th.them{color:var(--muted, ${FlenxPalette.muted});text-align:center}
.fxcmp__t tbody td{border-top:1px solid var(--border, ${FlenxPalette.border});font-size:.95rem}
.fxcmp__t td.c{text-align:center}
.fxcmp__t tbody tr:last-child td.us{border-radius:0 0 12px 12px}
.fxcmp__note{display:block;font-size:.72rem;color:var(--muted, ${FlenxPalette.muted});margin-top:2px}
''';
