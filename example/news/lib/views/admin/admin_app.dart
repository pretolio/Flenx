...
class AdminApp extends StatelessWidget {
  ...
  static const _activity = [
    ActivityItem(
      ...
      subtitle: '"IA no jornalismo" · há 1 h',
    ),
    ActivityItem(
      icon: Icons.person_add_alt,
      title: 'Novo usuário',
      subtitle: 'editor@flenxnews.com · há 3 h',
    ),
    ActivityItem(
      icon: Icons.edit_outlined,
      title: 'Tela inicial atualizada',
      subtitle: 'hero alterado · hoje',
    ),
    ActivityItem(
      icon: Icons.favorite_outline,
      title: 'Pico de acessos',
      subtitle: '/blog/economia-juros · hoje',
    ),
  ];
  ...
  Widget build(BuildContext context) {
    return FlenxAdminApp(
      ...
      pages: {
        ...
        '/home': (c) =>
            const FlenxSettingsPage(title: 'Tela inicial', fields: _homeFields),
        '/settings': (c) =>
