...
class AboutPage extends StatelessComponent {
  ...
  static const _cards = [
    (
      '🎯',
      'A missão',
      'Levar a web ao patamar de PHP, Next e Astro — só que em Dart, reaproveitando os widgets do seu app.',
    ),
    ('⚙️', 'Como funciona', 'SSR com jaspr, ilhas de widgets Flutter reais e SEO/GEO/AEO gerados a partir das rotas.'),
    (
      '👥',
      'Para quem',
      'De iniciantes que querem um site rápido a times que já têm um app Flutter e querem web de verdade.',
    ),
  ];
      ...
      child: FlenxColumn(cross: FlenxAlign.stretch, [
        FlenxSection(
          child: FlenxColumn(gap: 14, maxWidthPx: 760, [
            const FlenxText('Sobre o projeto', color: FlenxPalette.primary, weight: 700),
        ...
        FlenxSection(
          ...
          child: FlenxColumn(gap: 28, cross: FlenxAlign.stretch, [
            const FlenxText('Por que existe', align: FlenxTextAlign.center, color: FlenxPalette.primary, weight: 700),
            const FlenxHeading('A web merece a DX do Flutter', align: FlenxTextAlign.center),
            FlenxGrid(
              minItemWidth: 280,
              [
        ...
        FlenxSection(
          child: FlenxColumn(gap: 12, cross: FlenxAlign.center, [
            const FlenxText('Demonstração', align: FlenxTextAlign.center, color: FlenxPalette.primary, weight: 700),
            const FlenxHeading('Embute qualquer site ou vídeo', align: FlenxTextAlign.center),
            const FlenxText(
            ...
            const FlenxColumn(maxWidthPx: 760, cross: FlenxAlign.stretch, [
              IframeEmbed('https://www.youtube.com/embed/dQw4w9WgXcQ', title: 'Vídeo de exemplo', ratio: '16 / 9'),
            ]),
          ]),
        ),
        FlenxCta(
          ...
          action: const FlenxButton('Fale com a gente', href: '/#contato', variant: FlenxButtonVariant.ghost),
        ),
      ]),
    );
  }
