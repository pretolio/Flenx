...
class FlenxSite extends StatelessComponent {
  ...
  static const _features = [
    ...
    Feature(
      ...
      description: 'O mesmo código roda no app mobile e na web, como ilhas.',
    ),
    Feature(
      icon: '🔍',
      title: 'SEO automático',
      description: 'Meta tags, Open Graph, JSON-LD, sitemap e robots gerados sozinhos.',
    ),
    Feature(
      icon: '🤖',
      title: 'Pronto para IA',
      description: 'llms.txt e llms-full.txt + boas práticas de GEO/AEO embutidas.',
    ),
    Feature(
      icon: '📝',
      title: 'Blog em markdown',
      description: 'Content collections com categorias e tags, estilo Astro.',
    ),
    ...
    return FlenxPage(
      ...
      [
        ...
        const FlenxHero(
          ...
          subtitle:
              'SSR real, widgets Flutter de verdade e SEO/GEO/AEO '
        ...
        FlenxHeroSplit(
          ...
          child: FlenxColumn(gap: 14, [
            const FlenxText('Um código, dois mundos', color: FlenxPalette.primary, weight: 700),
            ...
            FlenxButton('Conhecer os exemplos', href: '#novidades', variant: FlenxButtonVariant.ghost),
          ]),
        ),
        const FlenxSteps(
          ...
          animate: true,
          steps: [
            FlenxStep('Escreva uma vez', 'Seus widgets Flutter rodam no app e na web — mesmo código.'),
            FlenxStep('Anote a rota', 'Com @FlenxPage/@Ssr o build gera SSR, sitemap, robots e llms.txt.'),
            FlenxStep('Publique', 'Conteúdo indexável por Google e por motores de IA, sem esforço.'),
          ],
        ),
        const FaqSection(),
        const FlenxCta(
          ...
          action: FlenxButton('Quero começar', href: '#contato', variant: FlenxButtonVariant.ghost),
        ),
