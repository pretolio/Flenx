...
/// Admin da loja — preenche o [FlextAdminApp] da lib com as telas prontas
...
class AdminApp extends StatelessWidget {
  ...
  static const _stats = [
    ...
    DashboardStat(
        ...
        trend: 'mês'),
    DashboardStat(
        icon: Icons.people_outline, label: 'Usuários', value: '2', trend: ''),
  ];
  ...
  ResourceConfig get _products => const ResourceConfig(
        ...
        fields: [
          ...
          ResourceField('price', 'Preço (ex.: 199.90)',
  ...
  ResourceConfig get _orders => const ResourceConfig(
        ...
        fields: [
          ...
          ResourceField('status', 'Status', kind: FieldKind.select, options: [
            'Novo',
            'Pago',
            'Enviado',
            'Concluído',
  ...
  Widget build(BuildContext context) {
    return FlextAdminApp(
      ...
      pages: {
        ...
        '/products': (c) => FlextResourcePage(config: _products),
        '/orders': (c) => FlextResourcePage(config: _orders),
        '/users': (c) => FlextResourcePage(config: _users),
