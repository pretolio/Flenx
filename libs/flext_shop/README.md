...
**Loja de exemplo** do [Flext](../flext) — catálogo de produtos montado **100% em Dart** com o kit do framework (sem HTML/CSS). Demonstra: home com destaques, catálogo, **página por produto** (rota + SEO própria, no sitemap), e "comprar via WhatsApp".

## Estrutura (o que você edita)

```
lib/
├── main.dart                  # FlextApp.run(...)
