...
class FlextFooterColumn {
  const FlextFooterColumn(this.title, this.links);
  final String title;
...
class FlextFooter extends StatelessComponent {
  const FlextFooter({
    required this.brand,
    this.tagline,
    this.columns = const [],
    this.copyright,
    this.background = FlextPalette.darkBg,
    super.key,
  });

  final String brand;
  final String? tagline;
  final List<FlextFooterColumn> columns;
            ...
            if (copyright != null)
              div(
                  styles: Styles(raw: {
                    'margin-top': '32px',
                    'padding-top': '20px',
                    'border-top': '1px solid ${FlextPalette.darkBorder}',
                    'color': '#94a3b8',
                    'font-size': '14px',
                  }),
                  [.text(copyright!)]),
