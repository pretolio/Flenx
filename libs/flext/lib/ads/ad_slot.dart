...
/// `FlextApp.run(ads: ...)` injeta automaticamente).
...
/// onde quiser exibir: `FlextAds(ads, path: ctx.path)` ou
/// `FlextAds(ads, category: 'Tecnologia', position: AdPosition.top)`.
class FlextAds extends StatelessComponent {
  const FlextAds(
    this.config, {
    this.path,
    this.category,
