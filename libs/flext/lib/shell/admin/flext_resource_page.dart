...
class FlextResourcePage extends StatefulWidget {
  const FlextResourcePage({
  ...
  @override
  State<FlextResourcePage> createState() => _FlextResourcePageState();
}

class _FlextResourcePageState extends State<FlextResourcePage> {
