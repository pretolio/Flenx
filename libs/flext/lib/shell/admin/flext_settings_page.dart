...
class FlextSettingsPage extends StatefulWidget {
  const FlextSettingsPage({
  ...
  @override
  State<FlextSettingsPage> createState() => _FlextSettingsPageState();
}

class _FlextSettingsPageState extends State<FlextSettingsPage> {
