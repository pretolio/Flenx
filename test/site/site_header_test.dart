...
import 'package:flenx/site/site.dart';
  ...
  group('SiteHeader (institucional)', () {
    testComponents('renderiza logo, menus, dropdown e botão de login', (
      ...
      tester.pumpComponent(
        const SiteHeader(
          brand: SiteBrand(label: 'Flenx', homeHref: '/'),
          links: [
            MenuLink(label: 'Início', href: '/'),
            MenuLink(
              label: 'Produtos',
              children: [MenuLink(label: 'Blog', href: '/blog')],
            ),
          ],
          loginLabel: 'Entrar',
